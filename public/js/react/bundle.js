...
/***/ function(module, exports, __webpack_require__) {
	...
	var DollComponent, DollImage, FoundDoll, MissingDoll, React;

	React = __webpack_require__(22);

	MissingDoll = React.createClass({
	  render: function() {
	    return React.createElement("h2", null, "Doll not found...");
	  }
	});
	...
	FoundDoll = React.createClass({
	  componentWillMount: function() {
	    ...
	    return console.dir(this.props);
	  },
	  imageCheck: function() {
	    if (doll.image) {
	      return React.createElement(DollImage, {
	        "doll": this.props.doll
	      });
	    }
	  },
	  render: function() {
	    return React.createElement("div", null, React.createElement("header", null, React.createElement("h1", null, this.props.doll.name), React.createElement("h5", null, "Posted by  ", this.props.doll.owner.name.first, " ", this.props.doll.owner.name.last)), React.createElement("div", {
	      "className": "doll"
	    }, this.imageCheck(), this.props.doll.content.full));
	  }
	});
	...
	DollComponent = React.createClass({
	  componentWillMount: function() {
	    ...
	    return this.dollCheck();
	  },
	  dollCheck: function() {
	    console.log("dollCheck - props: ");
	    console.dir(this.props);
	    console.dir(this.props.doll);
	    if (this.props.doll) {
	      return this.dolled = React.createElement(FoundDoll, {
	        "doll": this.props.doll
	      });
	    } else {
	      return this.dolled = React.createElement(MissingDoll, null);
	    }
	  },
	  render: function() {
	    return React.createElement("div", {
	    ...
	    }, React.createElement("article", null, React.createElement("p", null, React.createElement("a", {
	      "href": "'/dolls'"
	    }, "\u2190 back to the dolls"), React.createElement("hr", null), (this.props.doll.face ? React.createElement("h2", null, "Coffeescript is magic!") : React.createElement("h2", null, "Coffeescript sucks!")))))));
	  }
	});
